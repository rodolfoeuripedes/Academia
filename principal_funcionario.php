...
<!-- ===================Inserir novo funcionario=================== -->
    <b>Inserir Funcionário</b>
    <br>
    <table border='1'>
        <thead>
        <tr>
            <th width='200'>Nome do Funcionário</th>
        ...
        <tbody>
        <form name='inserir' method='post' action='inserir_funcionario.php' target='mainFrame_funcionario'>
            <tr>
...
<br>
<BR>
<b>Lista de Funcionários Ativos. <?php echo $count ?> registros encontrados</b>
<br>
    ...
    if ($row['15']==1){
     ...
     <?php echo"</select></td>
            ...
            <td><select name='cargo' style='$style'>"; ?>
                <option value='Proprietario' <?php echo $row['13'] == 'Proprietario' ? 'selected':'' ?> >Proprietario &#8195;&#8195;</option>
                <option value='Recepcionista' <?php echo $row['13'] == 'Recepcionista' ? 'selected':'' ?> >Recepcionista &#8195;&#8195;</option>
     <?php echo"</select></td>
            <td><input type='password' size='18' name='senha' value='".$row['14']."' style='$style'></td>
            <td><select name='ativoInativo' style='$style'>"; ?>
                <option value='1' <?php echo $row['15'] == 1 ? 'selected':'' ?> >Ativo &#8195;&#8195;</option>
                <option value='0' <?php echo $row['15'] == 0 ? 'selected':'' ?> >Inativo &#8195;&#8195;</option>
     <?php echo"</select></td>
...
<BR>
<b>Lista de Funcionários Inativos. <?php echo $count ?> registros encontrados</b>
<br>
<table border='1' id='alter'>
      <thead>
	<tr>
