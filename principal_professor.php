...
echo "<table border='1'>
        <tr>
			...
			<td width='80'>Data de Nascimento</td>
                        ...
                        <td width='60'>Especialidade</td>
                        <td width='60'>Inserir</td>
        </tr>";
  echo "<form name='inserir' method='post' action='inserir_professor.php' target='mainFrame_professor'>";
  echo "<tr>
            ...
            <td><input type='text' size='18' name='especialidade' value=''></td>
...
echo "<b>Lista de Professors Ativos. ".$count." registros encontrados</b>";
echo "<br>";
echo "<table border='1'>
	<tr>
            <td width='20'>ID</td>
...
while ($row = $stmt->fetch()) {
    ...
    echo "<form name='".$row['0']."' method='post' action='update_professor.php' target='mainFrame_professor'>
        <tr>
            ...
            <td><input type='text' size='18' name='especialidade' value='".$row['15']."'></td>
...
echo "<b>Lista de Professors Inativos. ".$count." registros encontrados</b>";
echo "<br>";
echo "<table border='1'>
	<tr>
            <td width='20'>ID</td>
...
while ($row = $stmt->fetch()) {
    if ($row['16']==0){
    echo "<form name='".$row['0']."' method='post' action='professor_update.php' target='mainFrame_professor'>
        <tr>
            <td><input type='text' size='1' name='id' value='".$row['0']."'></td>
            <td><input type='text' size='18' name='nome' value='".$row['1']."'></td>
            <td><input type='text' size='10' name='dataNasc' value='".$row['2']."'></td>
